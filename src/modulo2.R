#Virginia Teodosio<virginia@ciencias.unam.mx>
#28 octubre de 2022
# sesion 1

#esta función es para mostrar la ayuda en R
help()

#Se puede usar pasándole como argumento el nombre de alguna otra función
help(rnorm)

#Esta llamada es equivalente
?rnorm

#Es la llamada de inicio de la ayuda de R
help.start()
